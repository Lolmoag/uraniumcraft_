...
@Mod("uraniumcraft")
public class UraniumcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(UraniumcraftMod.class);
	public static final String MODID = "uraniumcraft";

	public UraniumcraftMod() {
