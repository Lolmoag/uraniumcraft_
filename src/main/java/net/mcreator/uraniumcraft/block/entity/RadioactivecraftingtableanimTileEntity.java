package net.mcreator.uraniumcraft.block.entity;
...
public class RadioactivecraftingtableanimTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public RadioactivecraftingtableanimTileEntity(BlockPos pos, BlockState state) {
		super(UraniumcraftModBlockEntities.RADIOACTIVECRAFTINGTABLEANIM.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RadioactivecraftingtableanimTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RadioactivecraftingtableanimTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("radioactivecraftingtableanim");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new RadioactivecraftingtableguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
